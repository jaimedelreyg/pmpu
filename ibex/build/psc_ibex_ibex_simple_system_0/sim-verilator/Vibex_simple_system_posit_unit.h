...
VL_MODULE(Vibex_simple_system_posit_unit) {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ __PVT__PADD__DOT__l2__DOT__l1__DOT__genblk3__DOT__l__DOT__genblk3__DOT__out_vl;
        CData/*0:0*/ __PVT__PADD__DOT__l2__DOT__l1__DOT__genblk3__DOT__l__DOT__genblk3__DOT__out_vh;
        CData/*0:0*/ __PVT__PADD__DOT__l2__DOT__l1__DOT__genblk3__DOT__h__DOT__genblk3__DOT__out_vl;
        CData/*0:0*/ __PVT__PADD__DOT__l2__DOT__l1__DOT__genblk3__DOT__h__DOT__genblk3__DOT__out_vh;
    ...
    struct {
        IData/*29:0*/ __PVT__PDIV__DOT__m2_inv[2];
        IData/*29:0*/ __PVT__PDIV__DOT__genblk4__DOT__m2_inv_X_m2[1];
        SData/*15:0*/ __PVT__PDIV__DOT__genblk4__DOT__two_m2_inv_X_m2[1];
        QData/*50:0*/ __PVT__PDIV__DOT__dsr2__DOT__tmp[5];
        SData/*8:0*/ __PVT__PDIV__DOT__genblk2__DOT__i_uut__DOT__a1_inv_rom[256];
    };
    
    // LOCAL VARIABLES
    CData/*4:0*/ PADD__DOT____Vcellout__uut_reg_ro____pinNumber3;
