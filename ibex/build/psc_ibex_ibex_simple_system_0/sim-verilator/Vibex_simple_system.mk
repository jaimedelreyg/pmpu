...
VM_USER_CFLAGS = \
	...
	-std=c++11 -Wall -DVM_TRACE_FMT_FST -DTOPLEVEL_NAME=ibex_simple_system -g -O0 \
...
VM_USER_DIR = \
	...
	../src/psc_ibex_ibex_simple_system_0 \
...
verilator_sim_ctrl.o: ../src/lowrisc_dv_verilator_simutil_verilator_0/cpp/verilator_sim_ctrl.cc
	$(OBJCACHE) $(CXX) $(CXXFLAGS) $(CPPFLAGS) $(OPT_FAST) -c -o $@ $<
ibex_simple_system.o: ../src/psc_ibex_ibex_simple_system_0/ibex_simple_system.cc
	$(OBJCACHE) $(CXX) $(CXXFLAGS) $(CPPFLAGS) $(OPT_FAST) -c -o $@ $<

### Link rules... (from --exe)
Vibex_simple_system: $(VK_USER_OBJS) $(VK_GLOBAL_OBJS) $(VM_PREFIX)__ALL.a
